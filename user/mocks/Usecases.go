...
func (_m *Usecases) Create(ctx context.Context, _a1 models.User) (*models.User, error) {
...
func (_m *Usecases) Delete(ctx context.Context, id string) error {
...
func (_m *Usecases) GetByID(ctx context.Context, id string) (*models.User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Usecases) List(ctx context.Context, listOptions models.ListOptions) ([]*models.User, error) {
...
func (_m *Usecases) Update(ctx context.Context, _a1 models.User) (*models.User, error) {
	ret := _m.Called(ctx, _a1)
